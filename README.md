...
Edit `.env` with your Redis host/port/credentials.
...
- Live API: [https://rate-limited-api-service.onrender.com/](https://rate-limited-api-service.onrender.com/)
- Live docs: [https://rate-limited-api-service.onrender.com/docs](https://rate-limited-api-service.onrender.com/docs)
...
- [x] **Deploy on Azure or any cloud platform:** deployed on Render ([https://rate-limited-api-service.onrender.com/](https://rate-limited-api-service.onrender.com/))